...
pub-info:
  reference: >-
    <strong>Akpan E</strong>, Thean LJ, Baskota R, Mani J, Mow M, Sahukhan A, et al. “Costs of primary healthcare presentations and hospital admissions for scabies and related skin infections in Fiji, 2018-2019.” <em>PLOS Global Public Health.</em> 2024; 4(10):e0003706. doi:<a href="https://doi.org/10.1371/journal.pgph.0003706"><code>10.1371/journal.pgph.0003706</code></a>
  links:
  - name: Code notebook
    url: https://github.com/EdifofonA/ScabiesSSTI-Costs-Fiji
    icon: fa-brands fa-github
  - name: Final version
    url: https://doi.org/10.1371/journal.pgph.0003706
...
![Figure 1. Extrapolation of the total annual number of scabies and scabies-related SSTI cases from BigSHIFT trial in Northern Division to all divisions in Fiji based upon previous scabies and impetigo prevalence data.](method-extrapolate-costs.png)

![Figure 2. One-way sensitivity analysis on the impact of changing the base case parameter values to low and high values on the total annual healthcare costs (in 2020 US\$) of scabies and related SSTIs in Fiji. Total annual cost is indicated by the black reference line (\$2.95 million). See Table 1 for the ranges used for this sensitivity analysis. ICU, intensive care unit; PHC, primary healthcare; SSTI, skin and soft tissue infection.](tornado-total-costs.png)
