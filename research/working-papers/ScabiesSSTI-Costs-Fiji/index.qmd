...
pub-info:
  reference: >-
    <strong>Akpan E</strong>, Thean LJ, Baskota R, Mani J, Mow M, Sahukhan A, Kama M, Tuicakau M, Kado J, Romani L, Engelman D, Whitfeld M, Kaldor J, Steer A, and Carvalho N. “Costs of primary healthcare presentations and hospital admissions for scabies and related skin infections in Fiji, 2018-2019.” <em>PLOS Global Public Health</em> 2024; ##(#):##–##. doi:<a href="https://doi.org/10.########"><code>10.########</code></a>
  links:
  - name: Code notebook
...
![Figure 1. Extrapolation of the total annual number of scabies and scabies-related SSTI cases from BigSHIFT trial in Northern Division to all divisions in Fiji based upon previous scabies and impetigo prevalence data.](BigSHIFT-Extrapolation-Process.png)
